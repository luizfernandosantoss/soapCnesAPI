...
####no Windons DEL /s *.class
####no linux rm -rf *.class

a requisição  autentica no header do soap, voce deve criar uma Classe que implementa o SOAPHandler para configurar o header antes de enviar a requisição.
