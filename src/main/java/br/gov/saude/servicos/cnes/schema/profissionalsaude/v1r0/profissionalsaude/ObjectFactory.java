 ...
 * generated in the br.gov.saude.servicos.schema.profissionalsaude.v1r0.profissionalsaude package. 
...
public class ObjectFactory {
    ...
    private final static QName _ProfissionalSaude_QNAME = new QName("http://servicos.saude.gov.br/schema/profissionalsaude/v1r0/profissionalsaude", "ProfissionalSaude");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.gov.saude.servicos.schema.profissionalsaude.v1r0.profissionalsaude
     * 
     */
