...
public class EstabelecimentoSaudeFault
    extends Exception
{
     ...
     * @param message
     */
    public EstabelecimentoSaudeFault(String message, MSFalha faultInfo) {
        super(message);
     ...
     * @param message
     */
    public EstabelecimentoSaudeFault(String message, MSFalha faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
