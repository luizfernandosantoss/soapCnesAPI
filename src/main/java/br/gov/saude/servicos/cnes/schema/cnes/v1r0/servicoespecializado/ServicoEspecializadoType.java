...
import br.gov.saude.servicos.cnes.schema.cnes.v1r0.servicoclassificacoes.ServicoClassificacoesType;


/**
 * <p>Classe Java de ServicoEspecializadoType complex type.
 * 
...
@XmlType(name = "ServicoEspecializadoType", propOrder = {
    "codigo",
    "descricao",
    "classificacoes"
})
public class ServicoEspecializadoType {
     ...
     * This is why there is not a <CODE>set</CODE> method for the classificacoes property.
     * 
     * <p>
    ...
    public List<ServicoClassificacoesType> getClassificacoes() {
        if (classificacoes == null) {
            classificacoes = new ArrayList<ServicoClassificacoesType>();
        }
